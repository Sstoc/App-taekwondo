// ==========================================================
// Vercel Serverless Function: Crear Preferencia de Mercado Pago (Checkout Pro)
// ==========================================================
...
export default async function handler(req, res) {
    ...
    try {
        ...
        if (!numAmount || numAmount <= 0) {
            return res.status(400).json({ error: 'Monto inválido para el pago' });
        }
        ...
        const origin = origin_url || (req.headers.host ? `https://${req.headers.host}` : 'https://app-taekwondo.vercel.app');
